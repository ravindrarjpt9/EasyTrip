...
public final class XmppConstants {
	...
	public static String XMPP_SERVER_IP_ADDRESS = "";
	...
	// Welcome message for new users details :
	public static String XMPP_ADMIN_USER_NAME = "neargroup_admin_1";
	public static String XMPP_ADMIN_PASSWORD = "neargroup_admin_1";
	public static String GROUP_WELCOME_MESSAGE = "";
	public static String GROUP_AUTO_MESSAGE = "";
